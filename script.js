...
let botonesOrden = document.getElementsByClassName("botones-orden")
...
let botonesCategorias = document.getElementsByClassName("botones-categoria")
for (let i = 0; i < botonesCategorias.length; i++) {
    if (i === 0) {
        botonesCategorias[0].addEventListener("click", () => {
            let productoFiltrado = filtrarPorCategoria(productos, "Juegos")
            mostrarPorductos(productoFiltrado)
        })
    } else if (i === 1) {
        botonesCategorias[1].addEventListener("click", () => {
            let productoFiltrado = filtrarPorCategoria(productos, "Consolas")
            mostrarPorductos(productoFiltrado)
        })
    } else {
        botonesCategorias[2].addEventListener("click", () => {
...
botonCarrito.addEventListener("click", () => {
    if (carrito.length <= 0) {
        ...
        carritoDeCompras[0].className = "carrito"
        mostrarCarrito(carrito)
...
let botonesCarrito = document.getElementsByClassName("botones-carrito")
